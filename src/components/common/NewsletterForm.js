    ...
    <div>
      <form className="flex w-full space-x-3">
        ...
        <div className="flex-none">
          <button
            className="flex-shrink-0 bg-brandteal text-white text-base font-semibold py-2 px-4 rounded-sm shadow-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-purple-200"
            type="submit"
          >
            Skicka
          </button>
